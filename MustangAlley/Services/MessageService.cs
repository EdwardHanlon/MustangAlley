...
namespace MustangAlley.Services
{
    public class MessageService : IEmailSender
    {
        ...
        public void SendEmail(string email)
        {
            ...
            sb.AppendLine("Congratulations – you are registered for the 19th annual Mustang Alley! To help keep the event fun and safe, we do have a few requirements. Please check the web-site for those requirements and other event details. You will also receive a reminder closer to the event. We look forward to seeing you in Ferndale, and hope you enjoy the event!");
